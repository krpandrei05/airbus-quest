...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var tvDrawerHp: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ivDrawerAvatar = navView.getHeaderView(0).findViewById(R.id.ivDrawerAvatar)
        tvDrawerHp = navView.getHeaderView(0).findViewById(R.id.tvDrawerHp)
        updateDrawerCharacter()
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            withContext(Dispatchers.Main) {
                character?.let {
                    ...
                    ivDrawerAvatar.setImageResource(iconRes)
                    tvDrawerHp.text = "HP: ${it.hp}/100"
                    Log.d(TAG, "Drawer updated: ${it.nickname}, HP=${it.hp}")
                }
            }
        }
    }
